const WelcomeSection = () => {
  return (
    <div className="text-center py-12 md:py-16">
      ...
      >
        Welcome to <span className="bg-gradient-to-r from-blue-300 to-indigo-300
      ...
      <div className="flex flex-wrap justify-center gap-4 max-w-2xl mx-auto">
        <div className="flex items-center gap-2 px-4 py-2 bg-white/15 backdrop-blur-sm rounded-full border border-white/25 shadow-sm">
          <svg className="w-5 h-5 text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
          </svg>
          <span className="text-sm text-white font-medium" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.3)' }}>Real-time Data</span>
        </div>
        <div className="flex items-center gap-2 px-4 py-2 bg-white/15 backdrop-blur-sm rounded-full border border-white/25 shadow-sm">
          ...
          <span className="text-sm text-white font-medium" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.3)' }}>Global Coverage</span>
        </div>
        <div className="flex items-center gap-2 px-4 py-2 bg-white/15 backdrop-blur-sm rounded-full border border-white/25 shadow-sm">
          ...
          <span className="text-sm text-white font-medium" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.3)' }}>5-Day Forecast</span>
        </div>
      </div>
      ...
      <div className="mt-12 animate-bounce">
        ...
        <p className="text-sm text-white/60 mt-2" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.3)' }}>Search for a city above</p>
      </div>
    </div>
  );
};
